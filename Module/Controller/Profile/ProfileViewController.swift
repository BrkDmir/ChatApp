...
class ProfileViewController: UIViewController {
    ...
    private let profileImageView = CustomImageView(backgorundColor: .lightGray, cornerRadius: 20)
    ...
    private func configureUI(){
        ...
        profileImageView.anchor(top: view.safeAreaLayoutGuide.topAnchor, paddingTop: 25)
