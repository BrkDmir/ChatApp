...
//  ChatApp
//
//  Created by Berkay DEMİR on 21.01.2026.
//
...
class CustomInputView: UIView {
    ...
    private lazy var postBackgroundColor: CustomImageView = {
        ...
        let iv = CustomImageView(width: 40, height: 40, backgorundColor: .red, cornerRadius: 20)
    ...
    private lazy var cancelButton: UIButton = {
     ...
     fileprivate lazy var sendRecordButton: UIButton = {
        let button = UIButton(type: .system)
    ...
    @objc func handlePostButton() {
        print("Post Button Did Tapped...")
        delegate?.inputView(self, withUploadMessage: inputTextView.text)
    }
